      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#6b7a5d] flex-col justify-between p-10">
        ...
        <div>
          <h1 className="font-display text-3xl md:text-4xl font-semibold text-white mb-4 leading-tight">
            Join thousands of lawn owners getting expert guidance.
          </h1>
          <p className="text-white/70">
            Personalized advice. Zero guesswork.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full border border-[#e5e5e5] hover:bg-[#f5f5f5] text-[#1a1a1a] font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-3 text-sm"
          >
          ...
          <p className="text-center text-[#a3a3a3] text-sm mt-6">
            ...
            <Link href="#" className="underline hover:text-[#737373]">Terms of Service</Link>
            {" "}and{" "}
            <Link href="#" className="underline hover:text-[#737373]">Privacy Policy</Link>.
          </p>
        </div>
      </div>
    </div>
