  ...
  return (
    <div className="h-full overflow-y-auto p-3 sm:p-4 lg:p-6">
      ...
      <div className="flex-shrink-0 max-w-4xl mx-auto w-full">
        {/* Tab Header */}
        <div className="bg-[#e8e5e0] rounded-t-xl border border-[#e5e5e5] border-b-0">
          <div className="flex">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                ...
                className={`flex-1 flex items-center justify-center gap-1 sm:gap-2 px-1 sm:px-4 py-3 text-[10px] sm:text-sm font-medium whitespace-nowrap transition-colors ${
                  activeTab === tab.id
                    ? "text-[#7a8b6e] bg-white rounded-t-xl"
        ...
        {/* Tab Content */}
        <div className="bg-white rounded-b-xl border border-[#e5e5e5] border-t-0">
