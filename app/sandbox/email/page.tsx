      ...
      <div className="flex-1 flex flex-col justify-center px-5 py-8 lg:hidden">
        <div className="space-y-6">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              <input
                ...
                autoFocus
                className="w-full h-14 px-4 rounded-2xl border-2 border-deep-brown/10 bg-white text-deep-brown placeholder:text-deep-brown/40 focus:outline-none focus:border-lawn text-lg"
              />
              {error && (
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-3 w-full h-14 bg-lawn text-white font-bold rounded-2xl active:scale-[0.98] transition-transform disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
          ...
          <div className="space-y-3 pt-2">
            ...
            <button
              onClick={() => router.back()}
              className="inline-flex items-center gap-1.5 text-sm text-deep-brown/40 py-2"
            >
