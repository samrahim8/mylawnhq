  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col">
      ...
      <div className="w-full bg-deep-brown/5">
        <div className="h-1 bg-lawn w-3/4" />
      </div>
      ...
      <div className="flex-1 flex flex-col px-4 py-6 sm:py-12 sm:justify-center">
        <div className="w-full max-w-lg mx-auto">
          ...
          {/* What we know card */}
          <div className="bg-lawn/5 border border-lawn/15 rounded-xl p-4 mb-5">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="inline-flex items-center bg-white text-deep-brown text-sm font-medium px-3 py-1.5 rounded-full border border-deep-brown/10">
                📍 {zip}
              </span>
              <span className="inline-flex items-center bg-white text-deep-brown text-sm font-medium px-3 py-1.5 rounded-full border border-deep-brown/10">
                🌱 {grassLabel}
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-deep-brown/60">
              Makes your plan 10x more useful.
            </p>
          </div>
          ...
          <button
            ...
            className="w-full bg-lawn text-white rounded-2xl p-5 text-left transition-all hover:bg-lawn/90 active:scale-[0.98] shadow-sm mb-3"
          >
          ...
          <button
            ...
            className="w-full bg-white border border-deep-brown/10 rounded-2xl p-4 text-left transition-all hover:border-deep-brown/20 hover:shadow-sm active:scale-[0.98]"
          >
            <div className="flex items-center justify-between">
              <div>
                <h2 className="font-medium text-deep-brown">
                  I want to add more details
                </h2>
                <p className="mt-0.5 text-sm text-deep-brown/50">
