...
export default function ActivityModal({
  ...
  return (
    <div className="fixed inset-x-0 top-0 z-50 flex items-end sm:items-center justify-center sm:p-4 overflow-hidden" style={{ height: '100dvh' }}>
      {/* Backdrop */}
      <div
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-t-2xl sm:rounded-2xl shadow-xl w-full max-w-md max-h-[85dvh] sm:max-h-[85vh] flex flex-col overflow-hidden sm:mx-2">
        {/* Header */}
